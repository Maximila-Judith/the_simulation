    ...
    return (
        <div className={`${isCall ? 'translate-y-0' : 'translate-y-full'} transition duration-1000 ease-out transform flex opacity-100 justify-center bg-emerald-50 flex-wrap content-end h-full`} >
            ...
            <div className=" flex flex-col space-y-4 bg-gray-300 w-full h-screen p-8 px-14">
                <Card className={`${isCall ? 'translate-y-0' : 'translate-y-full'} transition duration-700 ease-in-out transform bg-neutral-700 border-zinc-500 hover:border-2 rounded-none  hover:border-gray-400 w-full h-[200px] p-0 mt-0 text-center`}>
                    <div className=" h-full flex flex-col ">
                        <CardHeader className="flex h-1/5 p-0 bg-gradient-to-r from-teal-700 to-teal-900 pt-1 pl-2">
                            <CardTitle>
                                <div className="flex text-sm text-neutral-300 justify-start">
                                    <div className="flex flex-row items-center gap-2 ">
                                        <Percent className="text-green-800 bg-white rounded-full p-1 size-6 " />
                ...
                <Card className={`${isCall ? 'translate-y-0' : 'translate-y-full'} transition duration-700 ease-in transform bg-neutral-700 border-zinc-500 rounded-none hover:border-2  hover:border-gray-500 w-full h-[200px] p-0 mt-0 text-center`}>
                    <div className="h-full flex flex-col">
                        <CardHeader className="flex h-1/5 p-0 bg-gradient-to-r from-teal-700 to-teal-900 pt-1 pl-2">
                            <CardTitle>
                                <div className="flex text-sm text-neutral-300 justify-start">
                                    <div className="flex flex-row items-center gap-2">
                                        <Plus className="text-green-800 bg-white  rounded-full p-1 size-6" />
                ...
                <Card className={`${isCall ? 'translate-y-0' : 'translate-y-full'} transition duration-700 ease-in transform bg-neutral-700 rounded-none hover:border-2 hover:border-gray-400 w-full h-[200px] p-0 mt-0 text-center`}>
                    <div className="h-full flex flex-col">
                        <CardHeader className="flex h-1/5 p-0 bg-gradient-to-r from-teal-700 to-teal-900 pt-1 pl-2">
                            <CardTitle>
                                <div className="flex text-sm text-neutral-300 justify-start">
                                    <div className="flex flex-row items-center gap-1">
                                        <TriangleAlert className="text-green-800  bg-white  p-0.5 rounded-full size-6" />
