...
export default function Home() {
  ...
  const forAnswer = (answer: string[], next: string, now: string) => {
      ...
      <div className="flex justify-center items-center md:w-1/2 mx-auto shadow-xl rounded-2xl pb-2 bg-teal-2100">
        <div className="mb-10 space-y-5">
          <div className="mb-10 space-y-6">
            ...
            <>
             {(level.length === 1)? (<Body taxType={taxType} onAnswer={forAnswer} />) : (level.length === 2)? (<Body taxType= {taxType} onAnswer={forAnswer} />): (<Result Answers = {answers}/>)} 
