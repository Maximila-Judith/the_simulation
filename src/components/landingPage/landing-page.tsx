        ...
        <div >
            ...
            <div className=" pt-10 mt-10 text-center justify-center mb-5 p-20">
                ...
                <p>
                    ...
                    Essayez notre outil de simulation dès maintenant pour une expérience fiscale simplifiée et sans stress.
                </p>
            ...
            <div className="mt-5 pt-10 pr-20 pl-20 text-2xl pb-20 bg-gray-200 space-y-10">
                <div className="flex flex-row items-center gap-x-20 pl-20 pr-20 ">
                    ...
                    <div className="flex flex-col space-y-3 w-2/4">
                        <h1 className="text-black text-xl uppercase text-left">Impôt pour particulier</h1>
                        ...
                        <Link href="/" className="mt-6 bg-white text-black text-sm py-2 px-6 rounded-full self-start hover:bg-gray-400 transition duration-200">Simuler</Link>
                    </div>
                </div>
